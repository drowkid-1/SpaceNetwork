...
msg() { ##-->> COLORES, TITULO, BARRAS
  ...
  # Centrar texto
  -tit) echo -e " \e[48;5;214m\e[38;5;0m    🚀| ＳｐａｃｅＮｅｔｗｏｒｋ |🚀   \e[0m" ;;
  esac
}
#--- INFO DE SISTEMA
os_system() {
...
remove_script() {
  ...
  msg -bar
  echo -e "\e[1;97m        Esto borrara todos los archivos ＳｐａｃｅＮｅｔｗｏｒｋ"
  msg -bar
...
speed_test() {
  ...
  echo -e "\e[1;93m    PRUEBA DE VELOCIDAD DE HOSTING  $owner"
  msg -bar
...
<IfModule mod_gnutls.c>
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m    INSTALADOR MONO Y MULTI SSL | $owner"
  msg -bar
...
proto_squid() {
  ...
  fun_squid() {
    ...
    msg -tit
    msg -bar
    msg -ama "         INSTALADOR SQUID | $owner"
    msg -bar
    fun_ip
...
auth-user-pass" >/etc/openvpn/client-common.txt
  ...
  instala_ovpn() {
    ...
    coleta_variaveis() {
      echo -e "\033[1;32m     INSTALADOR DE OPENVPN | $owner"
      msg -bar
...
EOF
    ...
    install_prepare_password() {
      ...
      [ -z "${shadowsockspwd}" ] && shadowsockspwd="spacenetwork"
      msg -bar
  ...
  fun_shadowsocks() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m INSTALADOR SHADOWSOCK-LIBEV+(obfs) | $owner"
    msg -bar
    instaladossb_fun
...
proto_websockete() {
  ...
  activar_websokete() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m  INSTALADOR DE WEBSOCKET EDITABLE | $owner \033[1;37m"
    msg -bar
    porta_socket=
...
proto_popenvpn() {
  activar_openvpn() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY OPENVPN | $owner\033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
      echo -ne "\033[1;97m Digite el Puerto para el Websoket:\033[1;92m" && read -p " " -e -i "8081" porta_socket
...
proto_ppublico() {
  ...
  activar_ppublico() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PUBLICO | $owner\033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
...
proto_pprivado() {
  activar_pprivado() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PRIVADO | $owner\033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
...
proto_pgettunel() {
  activar_gettunel() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE GETTUNEL | $owner\033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
...
proto_ptcpover() {
  activar_tcpover() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE TCPOVER | $owner \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
...
sshl_install() {
  ...
  sslh_inicial() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m           INSTALADOR SSLH  | $owner"
    msg -bar
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m          INSTALADOR DE SSLH | $owner"
  msg -bar
...
control_v2ray() {
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m       CONTROLADOR DE V2RAY (WEBSOCKET+TLS) | $owner"
  msg -bar
...
controlador_ssr() {
 ...
 En el navegador, abra el enlace del codigo QR, puede\n ver la imagen del codigo QR."
  ...
  Set_config_user() {
    ...
    [[ -z "${ssr_user}" ]] && ssr_user="spacenetwork"
  ...
  Set_config_password() {
    ...
    [[ -z "${ssr_password}" ]] && ssr_password="spacenetwork"
...
msg -title
msg -bar
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mINSTALAR PROTOCOLOS\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;76mSERVICIOS PLUS |$owner \e[0;97m\n"
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mINSTALAR PROTOCOLOS\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;72m WS-EPRO \e[0;97m\n"
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mINSTALAR PROTOCOLOS\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;72mSubdomain \e[0;97m\n"
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mINSTALAR PROTOCOLOS\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;72m BadVPN(PRO) \e[0;97m\n"
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mINSTALAR PROTOCOLOS\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;76m TOOLS PLUS \e[0;97m\n"
msg -bar
read -r splus
if [[ "${splus}" == "1" || "${splus}" == "01" ]]; then
	clear && clear && echo -e "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31mESCRIBA SU PUERTO EPRO:\033[0m";read port
	echo -e "$port está disponible, ahora elija el puerto de anclaje: " && read -r portanc && echo -e "Bien, ahora elija 101, 200, 400, 500" && echo -e "\e[1;32mWS-EPRO INSTALADO CORRECTAMENTE \e[0m" && read -p "Enter para continuar"
elif [[ "${splus}" == "2" || "${splus}" == "02" ]]; then
	echo -e "SERVICIO PREMIUM NO DESBLOQUEADO" && read -p "Enter para continuar"
else
	echo -e "$owner"
fi
}
...
XLLiveUD"
  ...
  Ban_BT() {
    ...
    msg -tit
    msg -bar
    echo -e "\e[1;93m              PANEL DE FIREWALL $owner"
    msg -bar
    check_BT
...
v11=$(cat /etc/SCRIPT-LATAM/temp/version_actual)
v22=$(cat /etc/SCRIPT-LATAM/temp/version_instalacion)
[[ $v11 = $v22 ]] && checkver="\e[1;32m---------| SERVICIOS PLUS |-----------" || checkver="\e[1;31m----------| SERVICIOS PLUS |----------"
#MENU PRINCIPAL
